...
document.write('<script src="//cdn.jsdelivr.net/gh/TechainLau/customGoindex@latest/js/mdui.min.js"></script>');
...
<script src="//cdn.jsdelivr.net/gh/TechainLau/customGoindex@latest/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/TechainLau/customGoindex@latest/js/ext-language_tools.js"></script>
	`;
  $('#content').html(content);
