 ...
 */
// 在head 中 加载 必要静态
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/TechainLau/GoIndex/css/mdui_v2.min.css">');
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/TechainLau/GoIndex/css/nexmoe_v2.css">');
document.write('<script src="//cdn.jsdelivr.net/gh/TechainLau/GoIndex/js/mdui.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/TechainLau/GoIndex/js/flv.min.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/TechainLau/GoIndex/js/DPlayer.min.js"></script>');
// markdown支持
document.write('<script src="//cdn.jsdelivr.net/gh/TechainLau/GoIndex/js/markdown-it.min.js"></script>');
...
<script src="//cdn.jsdelivr.net/gh/TechainLau/GoIndex/js/ace.min.js"></script>
<script src="//cdn.jsdelivr.net/gh/TechainLau/GoIndex/js/ext-language_tools.min.js"></script>
	`;
  $('#content').html(content);
